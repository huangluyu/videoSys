...
<body onload="message('<s:property value="message"/>')">
	...
	<div class="big" align="center">
		...
		筛选:&nbsp<select name="gradeSelect" id="gradeSelect" onChange="select(this.value,subjectSelect.value,authorSelect.value)">
			...
			<select name="subjectSelect" id="subjectSelect" onChange="select(gradeSelect.value,this.value,authorSelect.value)">
